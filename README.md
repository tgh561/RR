...
2. **Проверка на наличие вершин в множестве `connected`**:
    ```python
...
5. **Добавление ребра в минимальный остов и обновление множества `connected`**:
    ```python
    mst.append(r)
    connected.add(r[1])
    connected.add(r[2])
